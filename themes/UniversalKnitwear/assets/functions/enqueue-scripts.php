...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
    ...
    wp_enqueue_style( 'slick-theme-css', get_template_directory_uri() . '/assets/slick/slick-theme.css', array(), '', 'all' );
...
function accordion_scripts() {
  ...
  wp_enqueue_script( 'accordion-easing-script', get_template_directory_uri() . '/assets/js/accordion/accordion.min.js');
  }
}
