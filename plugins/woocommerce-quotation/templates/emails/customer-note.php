...
<p><?php _e( "Hello, a note has just been added to your order:", 'woocommerce-quotation' ); ?></p>
...
<p><?php _e( "For your reference, your order details are shown below.", 'woocommerce-quotation' ); ?></p>

<?php do_action( 'woocommerce_email_before_order_table', $order, $sent_to_admin, $plain_text ); ?>

<h2><?php printf( __( 'Order #%s', 'woocommerce-quotation' ), $order->get_order_number() ); ?></h2>
