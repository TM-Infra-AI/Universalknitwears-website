...
<p><?php _e( "Our proposal have been accepted. The proposal is shown below for your reference:", 'woocommerce-quotation' ); ?></p>

<p><?php printf( __( 'You can proceed with the payment: %s.', 'woocommerce-quotation' ), '<a href="'.$order->get_checkout_payment_url().'">'.__( 'Pay', 'woocommerce-quotation' ).'</a>' ); ?></p>
...
<h2><?php echo __( 'The proposal:', 'woocommerce-quotation' ) . ' ' . $order->get_order_number(); ?></h2>
