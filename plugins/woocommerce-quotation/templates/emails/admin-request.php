...
<p><?php printf( __( 'You have received a quote request from %s. Their request is as follows:', 'woocommerce-quotation' ), $order->billing_first_name . ' ' . $order->billing_last_name ); ?></p>
