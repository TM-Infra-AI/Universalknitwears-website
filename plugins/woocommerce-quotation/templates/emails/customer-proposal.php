...
<p><?php _e( "Your Quote Request has been processed and we made this proposal for you. Our proposal are shown below for your reference:", 'woocommerce-quotation' ); ?></p>
...
<p><?php printf( __( 'You can %s or %s our proposal', 'woocommerce-quotation' ), 
        '<a href="'.$base_url.'&adq_action=accept">'.__( 'Accept', 'woocommerce-quotation' ).'</a>',
        '<a href="'.$base_url.'&adq_action=reject">'.__( 'Reject', 'woocommerce-quotation' ).'</a>' ) ?></p>
