...
<p><?php printf( __( 'The proposal from %s has been accepted. The request was as follows:', 'woocommerce-quotation' ), $order->billing_first_name . ' ' . $order->billing_last_name ); ?></p>
