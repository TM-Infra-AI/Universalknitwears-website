...
if ( ! class_exists( 'ADQ_Proposal_Reminder' ) ) :

/**
 * Quote remind email
 *
 * @class 	ADQ_Proposal_Reminder
 * @version     1.0.0
 ...
 * @extends     WC_Email
 */
class ADQ_Proposal_Reminder extends WC_Email {
	...
	function __construct() {
		...
		$this->id 		= 'proposal_reminder';
		$this->title 		= __( 'Remind proposal', 'woocommerce-quotation' );
		$this->description	= __( 'Remind proposal emails are sent to the customer when the proposal reminder have expired and haven acepted or rejected oru proposal.', 'woocommerce-quotation' );

		$this->heading 		= __( 'Our proposal has not been answered', 'woocommerce-quotation' );
		$this->subject      	= __( 'Our {site_title} quotation from {order_date} is proposed', 'woocommerce-quotation' );

		$this->template_html 	= 'emails/customer-proposal-reminder.php';
		$this->template_plain 	= 'emails/plain/customer-proposal-reminder.php';		
	...
	function get_subject() {
		$this->format_string( $this->subject );
	}
...
return new ADQ_Proposal_Reminder();
