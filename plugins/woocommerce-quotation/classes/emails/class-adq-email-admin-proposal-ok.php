...
if ( ! class_exists( 'ADQ_Admin_Proposal_Ok' ) ) :

/**
 * Admin Proposal Accepted email
 *
 * @class 	ADQ_Admin_Proposal_Ok
 * @version     1.0.0
 ...
 * @extends     WC_Email
 */
class ADQ_Admin_Proposal_Ok extends WC_Email {
	...
	function __construct() {
		...
		$this->id 		= 'admin_proposal_ok';
		$this->title 		= __( 'Admin proposal ok', 'woocommerce-quotation' );
		...
		$this->subject      	= __( 'A Customer have accepted our proposal', 'woocommerce-quotation' );

		$this->template_html 	= 'emails/admin-proposal-ok.php';
		$this->template_plain 	= 'emails/plain/admin-proposal-ok.php';
...
return new ADQ_Admin_Proposal_Ok();
