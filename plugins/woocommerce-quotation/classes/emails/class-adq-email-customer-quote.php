...
if ( ! class_exists( 'ADQ_Customer_Quote' ) ) :

/**
 * Customer Quote email
 *
 * @class 	ADQ_Customer_Quote
 * @version     1.0.0
 ...
 * @extends     WC_Email
 */
class ADQ_Customer_Quote extends WC_Email {
	...
	function __construct() {
		...
		$this->title 		= __( 'Customer request', 'woocommerce-quotation' );
		$this->description	= __( 'Customer request emails are sent to the customer after request is done.', 'woocommerce-quotation' );

		$this->heading 		= __( 'Your request has been received', 'woocommerce-quotation' );
		$this->subject      	= __( 'Your {site_title} Quote Request from {order_date} is received', 'woocommerce-quotation' );
