...
if ( ! class_exists( 'ADQ_Customer_Proposal' ) ) :

/**
 * Customer Proposal email
 *
 * @class 	ADQ_Customer_Proposal
 * @version     1.0.0
 ...
 * @extends     WC_Email
 */
class ADQ_Customer_Proposal extends WC_Email {
	...
	function __construct() {
		...
		$this->id 		= 'customer_proposal';
		$this->title 		= __( 'Send proposal', 'woocommerce-quotation' );
		$this->description	= __( 'Send proposal emails are sent to the customer when a proposal is ready to let choose the customer accepts or reject it.', 'woocommerce-quotation' );

		$this->heading 		= __( 'Our proposal', 'woocommerce-quotation' );
		$this->subject      	= __( 'Our {site_title} quotation from {order_date} is proposed', 'woocommerce-quotation' );

		$this->template_html 	= 'emails/customer-proposal.php';
		$this->template_plain 	= 'emails/plain/customer-proposal.php';
...
return new ADQ_Customer_Proposal();
