<?php
/*
	Plugin Name: DHL WooCommerce Extension (BASIC)
	...
	class wf_dhl_wooCommerce_shipping_setup {
		...
		public function __construct() {
			...
			public function plugin_action_links( $links ) {
				$plugin_links = array(
					'<a href="' . admin_url( 'admin.php?page=' . wf_get_settings_url() . '&tab=shipping&section=wf_dhl_shipping' ) . '">' . __( 'Settings', 'wf_dhl_wooCommerce_shipping' ) . '</a>',
		...
		public function wf_dhl_scripts() {
			...
			public function wf_dhl_wooCommerce_shipping_init() {
				...
				{
					$data = $_GET['post'];
					if(get_post_type($data) == 'shop_order')
					{
