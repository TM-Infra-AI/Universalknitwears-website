				...
				<?php
					...
					foreach ( $this->ordered_services as $value ) {
						...
						<tr>
							...
							<td><input type="checkbox" name="dhl_service[<?php echo $code; ?>][enabled]" <?php checked( ( isset( $this->custom_services[ $code ]['enabled'] ) || (!isset($this->custom_services[ $code ]['name'])) ), true ); ?> /></td>
