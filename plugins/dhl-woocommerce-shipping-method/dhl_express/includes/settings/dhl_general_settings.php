...
<table>
	<tr valign="top" ">
		<td style="width:40%;font-weight:800;">
			...
			For getting SiteID and Password for the United States, you need to write to xmlrequests@dhl.com along with your full Account details like account number, region, address, etc. to get API Access.

			For getting SiteID and Password for Australia, you are prompted to contact DHL Express by e-mailing onlineshipping.au@dhl.com.','wf-shipping-dhl') ?>"></span>	
		</td>
	...
	<tr valign="top">
		...
		<td scope="row" class="titledesc" style="display: block;margin-bottom: 20px;margin-top: 3px;">
			...
			<fieldset style="padding:3px;">
				<input class="input-text regular-input " type="checkbox" name="wf_dhl_shipping_enabled_label" id="wf_dhl_shipping_enabled_label" disabled="true" value="yes"  placeholder=""> <?php _e('Enable Shipping Label','wf-shipping-dhl') ?>  <span class="woocommerce-help-tip" data-tip="<?php _e('This option allows the user to create a label in the order admin page. Disabling it will hide the label creation option.','wf-shipping-dhl') ?>"></span> <small ><a style="color:red;" href="<?php echo admin_url( 'admin.php?page=' . wf_get_settings_url() . '&tab=shipping&section=wf_dhl_shipping&subtab=premium' ); ?>">Premium</a></small>
			</fieldset>
			<fieldset style="padding:3px;">
			...
			<fieldset style="padding:3px;"id="wf_dhl_insurance_related">
				Select Insurance Currency </br> <select name="wf_dhl_shipping_insure_currency" disabled="true" class="wc-enhanced-select">
				<?php 
				...
				<input type="number" min="0" step="0.00001" disabled="true" name="wf_dhl_shipping_insure_converstion_rate" value="<?php echo isset($general_settings['insure_converstion_rate']) ? $general_settings['insure_converstion_rate'] : ''; ?>"/><br/>
				<input class="input-text regular-input " disabled="true" type="checkbox" name="wf_dhl_shipping_insure_contents_chk" id="wf_dhl_shipping_insure_contents_chk" style=""  value="yes" placeholder=""> <?php _e('DHL Insurance Checkout Field','wf-shipping-dhl') ?> <span class="woocommerce-help-tip" data-tip="<?php _e('Enable this to insure your products. The insured value will be the total cart value.','wf-shipping-dhl') ?>"></span>
	...
	<tr valign="top">
		...
		<td scope="row" class="titledesc" style="display: block;margin-bottom: 20px;margin-top: 3px;">
			<fieldset style="padding:3px;">
				...
				<label for="wf_dhl_shipping_"><?php echo '<b>'.$selected_currency.' ('. get_woocommerce_currency_symbol($selected_currency).')</b>'; ?></label> <span class="woocommerce-help-tip" data-tip="<?php _e('This field picks the default currency of the country provided in "Country" of "Shipper Address" tab.','wf-shipping-dhl') ?>"></span><br/>
			</fieldset>
			<?php 
			...
			if($selected_currency != $default_currency)
			{
				?>
				<fieldset style="padding:3px;">
				<label for="wf_dhl_shipping_conversion_rate"><?php _e('Converstion Rate','wf-shipping-dhl') ?></label> <span class="woocommerce-help-tip" data-tip="Use this field to set the conversion rate of the Store’s currency <?php echo $default_currency; ?> to the DHL currency <?php echo $selected_currency; ?>."></span> <br/>	 
				<input class="input-text regular-input " type="number" min="0" step="0.00001" name="wf_dhl_shipping_conversion_rate" id="wf_dhl_shipping_conversion_rate" style="" value="<?php echo (isset($general_settings['conversion_rate'])) ? $general_settings['conversion_rate'] : ''; ?>" placeholder=""> 
				</fieldset>
				<?php
			}
			 ?>
