	...
	<tr valign="top" ">
		...
		<td scope="row" class="titledesc" style="display: block;margin-bottom: 20px;margin-top: 3px;">
			...
			<fieldset style="padding:3px;">
				...
				{ ?>
				<input class="input-text regular-input " type="radio" name="wf_dhl_shipping_availability"  id="wf_dhl_shipping_availability1" value="all" placeholder=""> <?php _e('Supports All Conturies','wf-shipping-dhl') ?>
				...
				<?php }else{ ?>
				<input class="input-text regular-input " type="radio" name="wf_dhl_shipping_availability" checked="true" id="wf_dhl_shipping_availability1"  value="all" placeholder=""> <?php _e('Supports All Conturies','wf-shipping-dhl') ?>
